...
object SchemaEtl {
  def main(args: Array[String]): Unit = {
    //System.setProperty("c", "D:\\Huohu\\下载\\hadoop-common-2.2.0-bin-master")
   val conf = new SparkConf().setAppName("")
    ...
    val df = sQL.createDataFrame(rowRDD,SchemaUtil.structType)
    df.write.parquet("B.parquent")
    sc.stop()
  }
}
